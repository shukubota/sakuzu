...
for phase in range(1,9):
	...
	for date in range(0,maxdate):
		...
		if ((dhead[date]>19980100)&(dhead[date]<20141008))or((dhead[date]>20150210)&(dhead[date]<20150402)):
			...
			comand="sshpass -p 'mitsuyacider' scp kubota@10.226.168.181:/disc10/yamamoto/GRIBdata/kubota2/"+str(year)+"/"+str(int(dhead[date]))+"prs-uv.grib data/"
	...
	np.save("winddata_no/uphase"+str(phase)+".npy",u)
	np.save("winddata_no/vphase"+str(phase)+".npy",v)
