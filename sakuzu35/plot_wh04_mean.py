...
for time in range(1,3):
	...
	countplot=np.zeros((sizem,sizen))
	count=0
	...
	for phase in phaselist:	
		...
		countcell=np.load("plotdata/wh04/"+dire+"/countplot%02d.npy"%phase)
		countplot+=countcell
		plotdata+=np.loadtxt(filename,delimiter=",")*countcell	
		print "plotdata",np.shape(plotdata)
	

	#plotdata=plotdata/8.
	plotdata=plotdata/countplot
	...
	plt.savefig("figure/wh04_"+dire+"/"+dire+str(time)+".png",bbox_inches="tight")
	plt.clf()	
