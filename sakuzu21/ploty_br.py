...
for i in range(1,9):
	...
	m.drawmeridians(np.arange(lon3-3,lon4,2.),labels=[False,True,False,True])	#経線
	...
	m.colorbar()
	if which==1.:
		output="figure/c_br/c"+"%02d"%i+".png"
		plt.title("Amplitude of Diurnal Precipitation [Phase="+"%02d"%i+"] [mm/h]")
	 
	if which==2:
		output="figure/phi_br/phi"+"%02d"%i+".png"
...
os.system("convert -delay 80 -loop 0 figure/c_br/c*.png figure/c_br.gif")
os.system("convert -delay 80 -loop 0 figure/phi_br/phi*.png figure/phi_br.gif")
