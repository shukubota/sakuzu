...
for phase in range(1,9):
	...
	plotcp=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu21/plotdata_wh04/c"+"%02d"%phase+".dat",delimiter=",")
	plotdata+=plotcp
...
for phase in range(1,9):
	...
	file="/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu21/plotdata_wh04/anmc"+"%02d"%phase+".dat"
