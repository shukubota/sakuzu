...
for i in range(1,2):
	...
	plotdata1=np.load("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu31/winddata/uphase"+str(i)+".npy")
	plotdata2=np.load("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu31/winddata/vphase"+str(i)+".npy")
	...
	if which==1:
		mabiki=3
		q=m.quiver(x[::mabiki,::mabiki],y[::mabiki,::mabiki],plotu[::mabiki,::mabiki],plotv[::mabiki,::mabiki],scale=100,color="black")
		qk = plt.quiverkey(q, 0.5, -0.07, 2, 'Wind Speed 2 m/s', labelpos='W',color="black")
		print "test\n"
	else:
