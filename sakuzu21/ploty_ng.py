...
for i in range(1,9):
	...
	m.colorbar()
	if which==1.:
		output="figure/c_ng/c"+"%02d"%i+".png"
		plt.title("Amplitude of Diurnal Precipitation [Phase="+"%02d"%i+"] [mm/h]")
	 
	if which==2:
		output="figure/phi_ng/phi"+"%02d"%i+".png"
...
os.system("convert -delay 80 -loop 0 figure/c_ng/c*.png figure/c_ng.gif")
os.system("convert -delay 80 -loop 0 figure/phi_ng/phi*.png figure/phi_ng.gif")
