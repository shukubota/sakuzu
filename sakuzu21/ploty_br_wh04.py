...
for i in range(1,9):
	...
	m.colorbar()
	if which==1.:
		output="figure_wh04/c_br/c_wh04"+"%02d"%i+".png"
		plt.title("Amplitude of Diurnal Precipitation [Phase="+"%02d"%i+"] [mm/h]")
	 
	if which==2:
		output="figure_wh04/phi_br/phi_wh04"+"%02d"%i+".png"
...
os.system("convert -delay 80 -loop 0 figure_wh04/c_br/c*.png figure_wh04/c_br_wh04.gif")
os.system("convert -delay 80 -loop 0 figure_wh04/phi_br/phi*.png figure_wh04/phi_br_wh04.gif")
