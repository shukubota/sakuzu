...
for i in range(1,9):
	...
	if which==1:
		m.contourf(x, y, plotcp,np.arange(0,1.,0.1),cmap=cm.afmhot_r)
		print "test\n"
	else:
		m.contourf(x, y, plotcp,np.arange(0,25,1))
	m.colorbar()
	if which==1.:
		output="figure_wh04/c_sm/c_wh04"+"%02d"%i+".png"
		plt.title("Amplitude of Diurnal Precipitation [Phase="+"%02d"%i+"] [mm/h]")
	 
	if which==2:
		output="figure_wh04/phi_sm/phi_wh04"+"%02d"%i+".png"
...
os.system("convert -delay 80 -loop 0 figure_wh04/c_sm/c*.png figure_wh04/c_sm_wh04.gif")
os.system("convert -delay 80 -loop 0 figure_wh04/phi_sm/phi*.png figure_wh04/phi_sm_wh04.gif")
