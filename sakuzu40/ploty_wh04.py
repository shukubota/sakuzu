...
#	print np.shape(plotdata)
	...
	plotdata3=np.load("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu31/hum/uphase"+str(i)+".npy")
	print plotdata3
...
#		plotcp[plotcp>23]-=24
	...
	plothum=(plotdata3[0,windlevel,mstart2:mend2+1,nstart2:nend2+1]+plotdata3[1,windlevel,mstart2:mend2+1,nstart2:nend2+1]+plotdata3[2,windlevel,mstart2:mend2+1,nstart2:nend2+1]+plotdata3[3,windlevel,mstart2:mend2+1,nstart2:nend2+1])/4.
...
#	if which==1:
		#a=m.contourf(x, y, plotcp,np.arange(-110,111,20.),cmap=cm.RDBu)
#		a=m.contourf(x, y, plotcp,np.arange(-0.35,0.36,0.1),cmap=cm.RdBu_r,extend="both")
...
#		b.set_label("LT(UTC+7)")
	...
	if which==1.:
		output="figure_wh04/c/c_wh04"+"%02d"%i+".png"
		plt.title("Phase%d"%i)
...
#		plt.title("Phase%02d"%i)
	...
	if which==1:
		...
		a=m.contourf(x, y, plothum,np.arange(0.006,0.015,0.001),cmap=cm.RdBu_r,extend="both")
