...
if which==1:
	...
	plotdata=np.load("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu39/plotdata/anm/phiampl.npy")
	datapr=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/wh04/phiampl.dat",delimiter=",")
elif which==3:
	plotdata=np.load("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu39/plotdata/anm/phiampl.npy")
	datapr=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/wh04/phimean.dat",delimiter=",")
	

print np.shape(plotdata)
print np.shape(datapr)

#################
#CUT
################
plotcp=-plotdata+datapr[mstart:mend+1,nstart:nend+1]
#plotcp+=1.
...
a=m.contourf(x, y, plotcp,np.arange(-3.5,4.,1.),cmap=cm.RdBu_r)
#m.colorbar()
...
if which==1:
    ...
    output="figure/dif_diurnal.png"
    #plt.title("phase_olr")

elif which==3:
    output="figure/dif_ir.png"
