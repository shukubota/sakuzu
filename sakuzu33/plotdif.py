...
if which==1:
	plotdata=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/bimodal/difampl.dat",delimiter=",")

else:   
	plotdata=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/bimodal/difmean.dat",delimiter=",")
...
m.contourf(x, y, plotcp,np.arange(-3.5,3.6,1))
m.colorbar()

if which==1:	 
	output="figure/difampl_bimodal.png"
	plt.title("Phase Lag of diurnal precipitation with OLR") 
	
else:
	output="figure/difmean_bimodal.png"
	plt.title("Phase Lag of mean precipitation with OLR") 
