...
if which==1:
	...
	plotdata=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/bimodal/phiampl.dat",delimiter=",")
   
elif which==2:
	plotdata=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/bimodal/phiolr.dat",delimiter=",")


elif which==3:
    plotdata=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu33/plotdata/bimodal/phimean.dat",delimiter=",")
...
if which==1:
	output="figure/mjophase_ampl_bimodal.png"
	plt.title("Phase_ampl")
	
elif which==2:
    output="figure/mjophase_olr_bimodal.png"
    plt.title("Phase_olr")

elif which==3:
    output="figure/mjophase_mean_bimodal.png"
    plt.title("Phase_mean")
