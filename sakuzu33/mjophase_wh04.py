...
for var in range(0,3):
	...
	for phase in range(1,9):
		print phase	
		if var==0:
			data=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu21/plotdata_wh04/c%02d.dat"%phase,delimiter=",")
		
		elif var==1:
			data=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu23/plotdata_wh04/p%d_rv.dat"%phase,delimiter=",")
			...
			data=np.loadtxt("/home/kubotashu/kubota/labo/sakuzu/sakuzu/sakuzu24/plotdata_wh04/dailyp%02d.dat"%phase,delimiter=",")
...
filename1="plotdata/wh04/phiampl.dat"
